...
You can obtain your gene references from GenBank or the alignment files generated by GeSeq above. All references can be included in a single fasta file `gene_ref.fas`. The headers should begin by gene names, an '_', and then a species name (will be ignored):
