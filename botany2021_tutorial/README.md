...
We will use the build-in plastid gene references to extract . The list of our reference species is [here](/database/plastid_reference_sp.csv). The list of the genes in the database is [here](/database/plastid_gene.list). 
